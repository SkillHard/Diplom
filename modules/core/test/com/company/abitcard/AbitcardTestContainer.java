...
public class AbitcardTestContainer extends TestContainer {

    public AbitcardTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/abitcard/app.properties",
    ...
    public static class Common extends AbitcardTestContainer {

        public static final AbitcardTestContainer.Common INSTANCE = new AbitcardTestContainer.Common();
